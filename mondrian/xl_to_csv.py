...
input_dir = "/media/gerardo/Data/Datasets/DECO/completed/"
output_dir = "/media/gerardo/Data/Datasets/DECO/completed_csv_hidden&merged/"

# input_dir = "/media/gerardo/Data/Datasets/DECO/test/"
# output_dir = "/media/gerardo/Data/Datasets/DECO/csv2/"
        ...
        for sheet in xls.sheetnames:
            ...
            if ws.sheet_state != 'hidden' and isinstance(ws,Worksheet):
                ...
                if not data_xls.empty:
                    ...
                    data_xls = data_xls[unhidden_cols] #problem with hidden columns consistency with gold std
                    data_xls.drop(hidden_rows, inplace=True)


                    #check out formats of dates but whatever
